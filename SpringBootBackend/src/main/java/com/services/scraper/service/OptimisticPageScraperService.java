...
@Service
public class OptimisticPageScraperService {
    @Value("${website.url}")
        ...
        try{
            ...
            for (PageItem eventItem : eventItems) {
                ...
                if (locationToAdd == null) {
                    ...
                    locationService.save(locationToAdd);
                } 
                ...
                appointmentToAdd.setType("UTD-Calendar-Event");
                appointmentToAdd.setLocation(locationToAdd);
                appointmentService.save(appointmentToAdd);
    ...
    private LocalDateTime dateFormatter(String date) {
        ...
        if (date.length() >= 21) {
            ...
            try {
                ...
                System.out.println("Invalid date-time string.");
                e.printStackTrace();
            }
        ...
        // For LocalDates
            ...
            try {
                ...
                LocalDateTime localDateTime = LocalDateTime.of(originalDate, LocalTime.NOON);
